...
#Here we're considering our various phases of flight, namely - takeoff, climb, cruise and ceiling and we also take turns.
#We calculate the T/W ratios for each phase of flight and find the maximum T/W ratio
#You will find the continued code for getting optimal WL in the file calc_optimalwingloading.py
